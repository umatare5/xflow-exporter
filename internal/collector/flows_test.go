...
xflow_exporter_bytes_total{direction="unknown",exporter_address="192.0.2.1",odid="0",version="netflow_v9"} 1500
xflow_exporter_bytes_total{direction="other",exporter_address="other",odid="other",version="other"} 0
...
xflow_host_pair_flows_total{direction="unknown",dst="10.0.0.2",exporter_address="192.0.2.1",input_ifindex="3",output_ifindex="4",src="10.0.0.1"} 2
xflow_host_pair_flows_total{direction="other",dst="other",exporter_address="other",input_ifindex="other",output_ifindex="other",src="other"} 0
`
...
xflow_host_pair_bytes_total{direction="unknown",dst="10.0.0.9",exporter_address="192.0.2.1",input_ifindex="3",output_ifindex="4",src="10.0.0.1"} 5000
xflow_host_pair_bytes_total{direction="unknown",dst="10.0.0.9",exporter_address="192.0.2.1",input_ifindex="3",output_ifindex="4",src="10.0.0.2"} 3000
...
# HELP xflow_host_pair_bytes_total Sampling-corrected bytes per source-destination pair, other carries the entry-bound fold
# TYPE xflow_host_pair_bytes_total counter
xflow_host_pair_bytes_total{direction="unknown",dst="10.0.0.9",exporter_address="192.0.2.1",input_ifindex="3",output_ifindex="4",src="10.0.0.1"} 1000
xflow_host_pair_bytes_total{direction="other",dst="other",exporter_address="other",input_ifindex="other",output_ifindex="other",src="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
		"xflow_host_pair_bytes_total"); err != nil {
...
xflow_application_bytes_total{application="https",direction="unknown",exporter_address="192.0.2.1"} 700
xflow_application_bytes_total{application="other",direction="other",exporter_address="other"} 0
...
xflow_asn_pair_bytes_total{direction="unknown",dst_asn="64501",exporter_address="192.0.2.1",src_asn="64500"} 700
...
xflow_service_bytes_total{direction="unknown",dst="10.0.0.2",exporter_address="192.0.2.1",input_ifindex="3",output_ifindex="4",port="443",proto="tcp",src="10.0.0.1"} 700
xflow_service_bytes_total{direction="other",dst="other",exporter_address="other",input_ifindex="other",output_ifindex="other",port="other",proto="other",src="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
...
xflow_country_pair_bytes_total{direction="unknown",dst_country="US",exporter_address="192.0.2.1",src_country="JP"} 700
xflow_country_pair_bytes_total{direction="unknown",dst_country="US",exporter_address="192.0.2.1",src_country="unknown"} 300
xflow_country_pair_bytes_total{direction="other",dst_country="other",exporter_address="other",src_country="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
...
xflow_vlan_pair_bytes_total{direction="unknown",dst_vlan="0",exporter_address="192.0.2.1",src_vlan="800"} 300
xflow_vlan_pair_bytes_total{direction="unknown",dst_vlan="801",exporter_address="192.0.2.1",src_vlan="800"} 700
xflow_vlan_pair_bytes_total{direction="other",dst_vlan="other",exporter_address="other",src_vlan="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
...
xflow_destination_bytes_total{direction="unknown",dst="10.0.0.2",exporter_address="192.0.2.1",port="443",proto="tcp"} 1000
xflow_destination_bytes_total{direction="other",dst="other",exporter_address="other",port="other",proto="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
...
xflow_dscp_bytes_total{direction="unknown",dscp="ef",exporter_address="192.0.2.1"} 700
xflow_dscp_bytes_total{direction="other",dscp="other",exporter_address="other"} 0
...
xflow_tcp_flags_bytes_total{direction="unknown",exporter_address="192.0.2.1",flags="syn,ack"} 700
xflow_tcp_flags_bytes_total{direction="other",exporter_address="other",flags="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
...
# HELP xflow_asn_pair_bytes_total Sampling-corrected bytes per AS pair, other carries the entry-bound fold
# TYPE xflow_asn_pair_bytes_total counter
xflow_asn_pair_bytes_total{direction="unknown",dst_asn="64515",exporter_address="192.0.2.1",src_asn="64514"} 107
xflow_asn_pair_bytes_total{direction="other",dst_asn="other",exporter_address="other",src_asn="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
...
# HELP xflow_asn_pair_bytes_total Sampling-corrected bytes per AS pair, other carries the entry-bound fold
# TYPE xflow_asn_pair_bytes_total counter
xflow_asn_pair_bytes_total{direction="unknown",dst_asn="64501",exporter_address="192.0.2.1",src_asn="64500"} 5000
xflow_asn_pair_bytes_total{direction="other",dst_asn="other",exporter_address="other",src_asn="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
		"xflow_asn_info", "xflow_asn_pair_bytes_total"); err != nil {
...
# HELP xflow_asn_pair_bytes_total Sampling-corrected bytes per AS pair, other carries the entry-bound fold
# TYPE xflow_asn_pair_bytes_total counter
xflow_asn_pair_bytes_total{direction="unknown",dst_asn="64501",exporter_address="192.0.2.1",src_asn="64500"} 400
xflow_asn_pair_bytes_total{direction="other",dst_asn="other",exporter_address="other",src_asn="other"} 0
`
	if err := testutil.CollectAndCompare(c, strings.NewReader(expected),
		"xflow_asn_info", "xflow_asn_pair_bytes_total"); err != nil {
