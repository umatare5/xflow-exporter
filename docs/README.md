...
`--enrich.mapping-file` names devices and their interfaces, which this decoder does not read even where a device exports them, and may name transport ports the built-in table does not cover.
