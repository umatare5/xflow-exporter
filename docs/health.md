...
- Three kinds of traffic read `unknown` until the file says otherwise: a dual-stack segment listed under one family, link-local addresses, and multicast destinations. A unicast prefix places none of them.
